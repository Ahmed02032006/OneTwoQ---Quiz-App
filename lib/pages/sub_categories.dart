...
//   Future<List<Map<String, dynamic>>> fetchCategories(String categoryId) async {
//     try {
//       final querySnapshot = await FirebaseFirestore.instance
...
//       // Print descriptions as we process documents
//       print("Fetched ${querySnapshot.docs.length} categories:");

//       return querySnapshot.docs.map((doc) {
//         final description = doc['description'] ?? 'No description available';
//         print(' - Description: $description'); // Print individual description
...
class SubCategories extends StatelessWidget {
  ...
  Future<Map<String, dynamic>> fetchCategoryDescription(String categoryId) async {
  try {
    ...
    return {
      'description': docSnapshot['description'] ?? 'No description available',
    };
  } catch (e) {
                      ...
                      Column(
                        children: [
                          ...
                          FutureBuilder<Map<String, dynamic>>(
                            future: fetchCategoryDescription(selectedCategoryId),
                            builder: (context, categorySnapshot) {
                              ...
                              final description = categorySnapshot.hasData
                                  ? categorySnapshot.data!['description'].toString()
